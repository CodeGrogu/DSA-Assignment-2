...
function testDeliveryAssignedContract() returns error? {
    DeliveryAssignedEvent event = {
        ...
        driverId: "drv-1",
        driverName: "Driver",
        driverPhone: "+26412345678",
        assignedAt: "2026-09-21T12:04:00Z"
    };
...
function testDeliveryStatusAliasContract() returns error? {
    DeliveryStatusEvent event = {
        ...
        driverId: "drv-1",
        status: PICKED_UP,
        currentLocation: {latitude: -22.57, longitude: 17.08},
    ...
    map<json> invalid = {
        ...
        driverId: "drv-1",
        status: "PICKED_UP",
        currentLocation: {latitude: 95.0, longitude: 17.08},
        updatedAt: "2026-09-21T12:05:00Z"
    };
